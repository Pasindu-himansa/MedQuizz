  ...
  return (
    <div className="min-h-screen p-4">
      <div className="max-w-2xl mx-auto">
        {/* Score Card */}
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-xl p-8 mb-4 text-center">
          <div className="flex justify-center mb-4">
            <IoStatsChartSharp size={48} color="white" />
          </div>
          ...
          <button
            ...
            className="w-full bg-indigo-500/70 backdrop-blur-sm border border-white/20 text-white py-3 rounded-xl font-semibold hover:bg-indigo-500/90 transition"
          >
            Back to Dashboard
          </button>
        </div>
